...
To put it in simpler terms, BIBE allows for sending bundles which themselves contain bundles as payloads. These encapsulated bundles can then for example be encrypted by adding a Bundle Confidentiality Block to the encapsulating bundle, thus providing a better defense against traffic analysis.
...
*Fig. 2: The different stages of bundles* 
